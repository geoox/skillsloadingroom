          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-neutral-700">
                ...
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-2 h-4 w-4">
                  <path clipRule="evenodd" d="M6 3C7.10457 3 8 2.10457 8 1H15V3L9 9V13H12V15H4V13H7V9L1 3V1H4C4 2.10457 4.89543 3 6 3ZM9 6C9.55228 6 10 5.55228 10 5C10 4.44772 9.55228 4 9 4C8.44772 4 8 4.44772 8 5C8 5.55228 8.44772 6 9 6Z" fill="#030708" fillRule="evenodd" /></svg>
