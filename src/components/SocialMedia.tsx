...
export const socialMediaProfiles = [
  { title: 'Instagram', href: 'https://www.instagram.com/skillsloadingroom/', icon: InstagramIcon },
  { title: 'Whatsapp', href: 'https://wa.me/40756830605', icon: WhatsappIcon },
  { title: 'Email', href: 'mailto:contact@skillsloadingroom.ro', icon: EmailIcon },
]
